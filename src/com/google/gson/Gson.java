...
public final class Gson {
	 ...
	 */
	public Gson() {
		this(Excluder.DEFAULT, FieldNamingPolicy.IDENTITY, Collections.<Type, InstanceCreator<?>>emptyMap(), false,
				false, DEFAULT_JSON_NON_EXECUTABLE, true, false, false, LongSerializationPolicy.DEFAULT,
	...
	Gson(final Excluder excluder, final FieldNamingStrategy fieldNamingPolicy,
		...
		factories.add(
				TypeAdapters.newFactory(float.class, Float.class, floatAdapter(serializeSpecialFloatingPointValues)));
	...
	public <T> TypeAdapter<T> getDelegateAdapter(TypeAdapterFactory skipPast, TypeToken<T> type) {
		...
		// Skip past if and only if the specified factory is present in the
		// factories.
		// This is useful because the factories created through JsonAdapter
		// annotations are not
