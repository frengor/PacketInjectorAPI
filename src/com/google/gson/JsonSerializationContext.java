...
public interface JsonSerializationContext {
	 ...
	 * @return a tree of {@link JsonElement}s corresponding to the serialized
	 *         form of {@code src}.
	 */
	 ...
	 * specific type information. It should never be invoked on the element
	 * received as a parameter of the
	 * {@link JsonSerializer#serialize(Object, Type, JsonSerializationContext)}
	 * method. Doing so will result in an infinite loop since Gson will in-turn
	 * call the custom serializer again.
	 *
	 * @param src
	 *            the object that needs to be serialized.
	 * @param typeOfSrc
