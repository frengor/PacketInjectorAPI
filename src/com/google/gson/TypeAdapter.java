...
public abstract class TypeAdapter<T> {
	 ...
	 * method, this write is strict. Create a
	 * {@link JsonWriter#setLenient(boolean) lenient} {@code JsonWriter} and
	 * call {@link #write(com.google.gson.stream.JsonWriter, Object)} for
	 * lenient writing.
	 *
	 * @param value
	 ...
	 * </pre>
	 * 
	 * Note that we didn't need to check for nulls in our type adapter after we
	 * used nullSafe.
	 */
	 ...
	 * similar {@link Gson#fromJson(java.io.Reader, Class) fromJson} method,
	 * this read is strict. Create a {@link JsonReader#setLenient(boolean)
	 * lenient} {@code JsonReader} and call {@link #read(JsonReader)} for
	 * lenient reading.
	 *
	 * @return the converted Java object. May be null.
	 * @since 2.2
	...
	/**
	 * Converts the JSON document in {@code json} to a Java object. Unlike
	 * Gson's similar {@link Gson#fromJson(String, Class) fromJson} method, this
